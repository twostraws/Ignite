...
struct Test {
    @Test("returns empty String for empty path", .publishingContext(), arguments: [
    ...
    @Test("returns the original path if there are no percent-encoded characters", .publishingContext(), arguments: [
    ...
    @Test("returns the path with percent-encoded instances replaced", .publishingContext(), arguments: [
