...
struct AnchorPointTests {
    ...
    @Test("Anchor point", .publishingContext(), arguments: zip(anchorPoints, anchorPointCSSValues))
    ...
    @Test("Custom anchor point", .publishingContext(), arguments: zip(Self.xCoordinates, Self.yCoordinates))
