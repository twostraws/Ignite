...
class AbbreviationTests: IgniteTestSuite {
    @Test("Basic Abbreviation", .publishingContext(), arguments: ["abbr"], ["abbreviation"])
    ...
    @Test("Single Element Abbreviation", .publishingContext(), arguments: ["abbreviation"], ["abbr"])
    ...
    @Test("Builder Abbreviation", .publishingContext(), arguments: ["abbreviation"], ["abbr"])
