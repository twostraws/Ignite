...
class GridTests: IgniteTestSuite {
    ...
    func gridWithThreeImagesAndWidth() async throws {
        ...
        <div class="col-md-4 gy-3"><img src="/images/photos/stack.jpg" alt="A door partly open." class="img-fluid" />\
        </div>\
        <div class="col-md-4 gy-3">\
        <img src="/images/photos/wind.jpg" alt="A windy day." class="img-fluid" />\
        </div>\
    ...
    func gridWithWrapping() async throws {
        ...
        <div class="col-md-4 gy-3"><img src="/images/photos/rug.jpg" alt="A nice rug." class="img-fluid" />\
        </div>\
        <div class="col-md-4 gy-3">\
    ...
    func gridWithWrappingTwoColors() async throws {
        ...
        <div class="col gy-3"><img src="/images/photos/car.jpg" alt="The window of a car." class="img-fluid" />\
        </div>\
        </div>
        """)
    }
