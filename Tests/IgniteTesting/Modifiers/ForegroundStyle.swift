...
struct ForegroundStyleTests {
    ...
    @Test("Color Foreground Styles Test", arguments: await zip(Self.testColors, Self.testRGBs))
    ...
    @Test("String Foreground Styles Test", arguments: await Self.testColorNames)
