...
class FontStyleModifierTests: IgniteTestSuite {
    ...
    @Test("Lead style on Text adds lead class", .publishingContext())
    ...
    @Test("Small style on Text adds small class", .publishingContext())
    ...
    @Test("Class-based styles on non-Text HTML use size class", .publishingContext(), arguments: [
    ...
    @Test("Title style on non-Text HTML uses size class instead of tag", .publishingContext())
    ...
    @Test("Font style on inline element applies class", .publishingContext())
