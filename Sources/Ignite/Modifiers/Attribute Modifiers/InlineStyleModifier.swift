...
@MainActor
private func inlineStyleModifier(_ styles: [InlineStyle], content: any HTML) -> any HTML {
...
@MainActor
private func inlineStyleModifier(_ styles: [InlineStyle], content: any InlineElement) -> any InlineElement {
