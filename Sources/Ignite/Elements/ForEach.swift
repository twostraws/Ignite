...
@MainActor
public struct ForEach<Data: Sequence>: HTML, Element, ListableElement, HeadElement, PassthroughElement {
    ...
    public init(_ data: Data, @HTMLBuilder content: @escaping (Data.Element) -> some HTML) {
        self.data = data
